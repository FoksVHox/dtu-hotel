    ...
    return (
        <section className="relative overflow-hidden bg-black text-white">
            ...
            >
                ...
                <h2
                    className={[
                        'mt-6 text-5xl leading-[1.05] font-semibold tracking-tight transition-all duration-700 ease-out md:text-6xl',
                        inView
                ...
                >
                    Sign up, walk through three short steps, and your dashboard
                    is live.
                </p>
