...
export default function RoomsStep({
    ...
    const removeRule = (idx: number) => {
        form.setData(
            'rules',
            form.data.rules.filter((_, i) => i !== idx),
        );
    };
        ...
        <form onSubmit={submit} className="flex flex-col gap-6">
            <header className="flex flex-col gap-2">
                ...
                <p className="text-sm text-neutral-500">
                    Define one or more numbering rules. We'll create the rooms
                    for you.
                </p>
            </header>
            ...
            <div className="flex flex-col gap-3">
                    ...
                    >
                        <Inline label="From">
                            <input
                                ...
                                className="h-11 w-24 rounded border border-neutral-300 px-3 focus:border-black focus:ring-1 focus:ring-black focus:outline-none"
                            />
                        </Inline>
                        <Inline label="To">
                            <input
                ...
                {form.errors.rules && (
                    <p className="text-sm text-red-600">{form.errors.rules}</p>
                )}
